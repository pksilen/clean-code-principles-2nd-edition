...
Below is an example of using the [validated-types](https://github.com/pksilen/validated-types) library to create a validated integer type that allows values between 1 and 10.
